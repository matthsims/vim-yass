...
" Defaults
let g:yass_interval = exists('g:yass_interval') ? g:yass_interval : 16
let g:yass_minimum = exists('g:yass_minimum') ? g:yass_minimum : 10
if g:yass_minimum < 0
  let g:yass_minimum = 10
endif
...
function! s:scroll_handler(timer) abort
  ...
  if l:speed <= g:yass_minimum
    let l:speed = g:yass_minimum
  endif
